...
This extension converts odometry messages into marker arrays for visualization in Foxglove. It renders the current pose, pose covariance, and a trajectory trail for each odometry topic.
